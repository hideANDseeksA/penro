...
def downgrade() -> None:
    op.drop_index(op.f('ix_taxpayer_remedy_taxpayer_id'), table_name='taxpayer_remedy')
    op.drop_index(op.f('ix_taxpayer_remedy_status'), table_name='taxpayer_remedy')
    op.drop_index(op.f('ix_taxpayer_remedy_remedy_type_id'), table_name='taxpayer_remedy')
    op.drop_index(op.f('ix_taxpayer_remedy_filing_date'), table_name='taxpayer_remedy')
    op.drop_index(op.f('ix_taxpayer_remedy_assessment_id'), table_name='taxpayer_remedy')
    op.drop_table('taxpayer_remedy')
    op.drop_index(op.f('ix_tax_payment_taxpayer_id'), table_name='tax_payment')
    op.drop_index(op.f('ix_tax_payment_payment_type'), table_name='tax_payment')
    op.drop_index(op.f('ix_tax_payment_payment_date'), table_name='tax_payment')
    op.drop_index(op.f('ix_tax_payment_clearance_id'), table_name='tax_payment')
    op.drop_index(op.f('ix_tax_payment_assessment_id'), table_name='tax_payment')
    op.drop_table('tax_payment')
    op.drop_index(op.f('ix_penalty_or_administrative_sanction_violation_id'), table_name='penalty_or_administrative_sanction')
    op.drop_index(op.f('ix_penalty_or_administrative_sanction_settled'), table_name='penalty_or_administrative_sanction')
    op.drop_index(op.f('ix_penalty_or_administrative_sanction_sanction_type'), table_name='penalty_or_administrative_sanction')
    op.drop_index(op.f('ix_penalty_or_administrative_sanction_sanction_date'), table_name='penalty_or_administrative_sanction')
    op.drop_table('penalty_or_administrative_sanction')
    op.drop_index(op.f('ix_violation_violation_type'), table_name='violation')
    op.drop_index(op.f('ix_violation_violation_date'), table_name='violation')
    op.drop_index(op.f('ix_violation_taxpayer_id'), table_name='violation')
    op.drop_index(op.f('ix_violation_status'), table_name='violation')
    op.drop_index(op.f('ix_violation_shipment_id'), table_name='violation')
    op.drop_index(op.f('ix_violation_return_id'), table_name='violation')
    op.drop_table('violation')
    op.drop_index(op.f('ix_tax_assessment_taxpayer_id'), table_name='tax_assessment')
    op.drop_index(op.f('ix_tax_assessment_shipment_id'), table_name='tax_assessment')
    op.drop_index(op.f('ix_tax_assessment_assessment_stage'), table_name='tax_assessment')
    op.drop_index(op.f('ix_tax_assessment_assessment_date'), table_name='tax_assessment')
    op.drop_table('tax_assessment')
    op.drop_index(op.f('ix_shipment_document_shipment_id'), table_name='shipment_document')
    op.drop_index(op.f('ix_shipment_document_document_type_id'), table_name='shipment_document')
    op.drop_index(op.f('ix_shipment_document_document_status'), table_name='shipment_document')
    op.drop_table('shipment_document')
    op.drop_index(op.f('ix_return_shipment_shipment_id'), table_name='return_shipment')
    op.drop_index(op.f('ix_return_shipment_return_id'), table_name='return_shipment')
    op.drop_index(op.f('ix_return_shipment_otp_reference'), table_name='return_shipment')
    op.drop_table('return_shipment')
    op.drop_index(op.f('ix_provincial_soil_depletion_tax_clearance_taxpayer_id'), table_name='provincial_soil_depletion_tax_clearance')
    op.drop_index(op.f('ix_provincial_soil_depletion_tax_clearance_shipment_id'), table_name='provincial_soil_depletion_tax_clearance')
    op.drop_index(op.f('ix_provincial_soil_depletion_tax_clearance_clearance_status'), table_name='provincial_soil_depletion_tax_clearance')
    op.drop_index(op.f('ix_provincial_soil_depletion_tax_clearance_application_date'), table_name='provincial_soil_depletion_tax_clearance')
    op.drop_table('provincial_soil_depletion_tax_clearance')
    op.drop_index(op.f('ix_provincial_monitoring_record_shipment_id'), table_name='provincial_monitoring_record')
    op.drop_index(op.f('ix_provincial_monitoring_record_provincial_office_id'), table_name='provincial_monitoring_record')
    op.drop_index(op.f('ix_provincial_monitoring_record_monitoring_date'), table_name='provincial_monitoring_record')
    op.drop_index(op.f('ix_provincial_monitoring_record_mining_operation_id'), table_name='provincial_monitoring_record')
    op.drop_table('provincial_monitoring_record')
    op.drop_index(op.f('ix_national_agency_document_shipment_id'), table_name='national_agency_document')
    op.drop_index(op.f('ix_national_agency_document_national_agency_id'), table_name='national_agency_document')
    op.drop_table('national_agency_document')
    op.drop_index(op.f('ix_shipment_taxpayer_id'), table_name='shipment')
    op.drop_index('ix_shipment_taxpayer_date', table_name='shipment')
    op.drop_index(op.f('ix_shipment_shipment_status'), table_name='shipment')
    op.drop_index(op.f('ix_shipment_shipment_date'), table_name='shipment')
    op.drop_index(op.f('ix_shipment_mining_operation_id'), table_name='shipment')
    op.drop_index(op.f('ix_shipment_mineral_id'), table_name='shipment')
    op.drop_index(op.f('ix_shipment_extraction_site_id'), table_name='shipment')
    op.drop_index(op.f('ix_shipment_buyer'), table_name='shipment')
    op.drop_table('shipment')
    op.drop_index(op.f('ix_permit_authority_permit_type'), table_name='permit_authority')
    op.drop_index(op.f('ix_permit_authority_permit_number'), table_name='permit_authority')
    op.drop_index(op.f('ix_permit_authority_mining_operation_id'), table_name='permit_authority')
    ...
    op.drop_index(op.f('ix_audit_log_logged_at'), table_name='audit_log')
    ...
    op.drop_index(op.f('ix_app_user_taxpayer_id'), table_name='app_user')
    op.drop_index(op.f('ix_app_user_role_id'), table_name='app_user')
    op.drop_index(op.f('ix_app_user_provincial_office_id'), table_name='app_user')
    op.drop_table('app_user')
    op.drop_index(op.f('ix_soil_depletion_tax_return_taxpayer_id'), table_name='soil_depletion_tax_return')
    op.drop_index(op.f('ix_soil_depletion_tax_return_return_status'), table_name='soil_depletion_tax_return')
    op.drop_index(op.f('ix_soil_depletion_tax_return_return_period'), table_name='soil_depletion_tax_return')
    op.drop_index(op.f('ix_soil_depletion_tax_return_filing_date'), table_name='soil_depletion_tax_return')
    op.drop_index('ix_return_taxpayer_period', table_name='soil_depletion_tax_return')
    op.drop_table('soil_depletion_tax_return')
    op.drop_index(op.f('ix_mining_operation_taxpayer_id'), table_name='mining_operation')
    op.drop_index(op.f('ix_mining_operation_status'), table_name='mining_operation')
    op.drop_index(op.f('ix_mining_operation_operation_type_id'), table_name='mining_operation')
    op.drop_index(op.f('ix_mining_operation_operation_name'), table_name='mining_operation')
    op.drop_table('mining_operation')
    op.drop_index(op.f('ix_extraction_record_mineral_id'), table_name='extraction_record')
    op.drop_index(op.f('ix_extraction_record_extraction_site_id'), table_name='extraction_record')
    op.drop_index(op.f('ix_extraction_record_extraction_date'), table_name='extraction_record')
    op.drop_table('extraction_record')
    op.drop_index(op.f('ix_books_examination_record_taxpayer_id'), table_name='books_examination_record')
    op.drop_index(op.f('ix_books_examination_record_provincial_office_id'), table_name='books_examination_record')
    op.drop_index(op.f('ix_books_examination_record_examination_date'), table_name='books_examination_record')
    op.drop_table('books_examination_record')
    op.drop_index(op.f('ix_annual_collection_report_provincial_office_id'), table_name='annual_collection_report')
    op.drop_index(op.f('ix_annual_collection_report_fiscal_year'), table_name='annual_collection_report')
    op.drop_table('annual_collection_report')
    op.drop_index(op.f('ix_taxpayer_taxpayer_name'), table_name='taxpayer')
    op.drop_index(op.f('ix_taxpayer_tax_identification_details'), table_name='taxpayer')
    ...
    op.drop_index(op.f('ix_mineral_mineral_name'), table_name='mineral')
    op.drop_index(op.f('ix_mineral_mineral_category'), table_name='mineral')
    op.drop_table('mineral')
    op.drop_index(op.f('ix_extraction_site_site_name'), table_name='extraction_site')
    op.drop_index(op.f('ix_extraction_site_municipality'), table_name='extraction_site')
    op.drop_table('extraction_site')
    op.drop_index(op.f('ix_document_type_stage'), table_name='document_type')
    op.drop_index(op.f('ix_document_type_mineral_scope'), table_name='document_type')
